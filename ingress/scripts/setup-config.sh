...
echo "3. Update ${CONF_DIR}/consortium-member-certs.json with your member certificates"
echo "4. Generate SSL certificates: ./scripts/generate-ssl-certs.sh"
echo "5. Generate client certificates: ./scripts/generate-client-cert.sh <member-id> <member-name>"
